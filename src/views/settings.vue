  ...
  <div class="settings-page" @click="clickOutside">
    <div class="container">
      <div v-if="showUserInfo" class="user">
        ...
        <div class="right">
          <button v-focusable="true" @click="logout">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="lang" v-focusable="true">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="appearance" v-focusable="true">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="musicLanguage" v-focusable="true">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="musicQuality" v-focusable="true">
            <option value="128000">
      ...
      <div v-if="isElectron" class="item">
        ...
        <div class="right">
          <select v-model="outputDevice" v-focusable="true">
            <option
      ...
      <div v-if="isElectron" class="item">
        ...
        <div class="right">
          <select v-model="cacheLimit" v-focusable="true">
            <option :value="false">
      ...
      <div v-if="isElectron" class="item">
        ...
        <div class="right">
          <button @click="clearCache()" v-focusable="true">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="lyricsBackground" v-focusable="true">
            <option :value="false">
      ...
      <div class="item">
        ...
        <div class="right">
          <select v-model="lyricFontSize" v-focusable="true">
            <option value="16">
      ...
      <section v-if="isElectron" class="unm-configuration">
        ...
        <div class="item">
          ...
          <div class="right">
            <select v-model="unmSearchMode" v-focusable="true">
      ...
      <div class="item">
        ...
        <div class="right">
          ...
          <button v-focusable="true" v-else @click="lastfmConnect()">
            授权连接
          </button>
        </div>
      </div>
      ...
      <div v-if="isElectron && !isMac" class="item">
        ...
        <div class="right">
          <select v-model="closeAppOption" v-focusable="true">
            <option value="ask">
      ...
      <div v-if="isElectron">
        ...
        <div class="item">
          ...
          <div class="right">
            <select v-model="proxyProtocol" v-focusable="true">

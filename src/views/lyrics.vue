<template>
  <transition name="slide-up">
    ...
    >
            ...
            <div class="top-part">
              ...
              <div class="top-right">
                ...
                <div class="buttons">
                  ...
                  <button-icon
                    v-focusable="true"
                    @left="tv_left('addPlayList')"
                    @right="tv_right('addPlayList')"
                    ref="tv_add_playlist"
      ...
      <div class="close-button" @click="toggleLyrics" v-focusable="true">
        <button>
...
export default {
  ...
  methods: {
    ...
    tv_right(e) {
      if (e == 'addPlayList') {
        this.$tv.requestFocus(this.$refs.tv_line_1);
      }
    },
    tv_left(e) {
      if (e == 'lyric') {
        this.$tv.requestFocus(this.$refs.tv_add_playlist);
      } else if (e == 'addPlayList') {
        this.$tv.requestFocus(this.$refs.tv_add_playlist);
      }
    },
    initDate() {
    ...
    playOrPause() {
      ...
      if (this.player.playing) {
        document
          .querySelector('#tv_songs_pic')
          .style.setProperty('transform', 'scale(1.05)');
        document
          .querySelector('#tv_songs_pic')
          .style.setProperty('transition', 'ease-in-out 0.2s');
      } else {
        document
          .querySelector('#tv_songs_pic')

<template>
  <div class="daily-recommend-card" @click="goToDailyTracks" v-focusable="true">
...
.daily-recommend-card.focus {
  transform: scale(1.05);
  transition: ease 0.2s;
}
.daily-recommend-card.focus .container {
  backdrop-filter: blur(20px);
  width: 100%;
  transition: ease 0.2s;
}
.daily-recommend-card.focus .title {
  color: #fff !important;
  transition: ease 0.2s;
}
</style>
